...
export function broadcastLobbies(clientTo: ClientInfo, lobbies: Map<string, Lobby>, clients: Map<string, ClientInfo>) {
...
export function broadcast(lobbyId: string, data: any, lobbies: Map<string, Lobby>, clients: Map<string, ClientInfo>) {
